...
define(["require", "exports", "esri/core/tsSupport/declareExtendsHelper", "esri/core/tsSupport/decorateHelper", "esri/core/accessorSupport/decorators", "esri/widgets/Widget", "esri/widgets/support/widget"], function (require, exports, __extends, __decorate, decorators_1, Widget, widget_1) {
    ...
    var CSS = {
        ...
        border: "widgets-drop-target--border",
        label: "widgets-drop-target--label",
        valid: "widgets-drop-target--valid",
        invalid: "widgets-drop-target--invalid",
    ...
    var DropTarget = /** @class */ (function (_super) {
        ...
        function DropTarget() {
            ...
            _this.own(_this.watch("view.container", function (value, oldValue) {
                if (oldValue) {
                    ...
                    // oldValue.removeEventListener("dragend", this._dragEnterHandler);
                ...
                if (value) {
                    ...
                    // value.addEventListener("dragend", this._dragEnterHandler);
        ...
        DropTarget.prototype.render = function () {
            var classes = (_a = {},
                _a[CSS.visible] = this.visible,
                _a[CSS.valid] = this.isValid,
                _a);
            return (widget_1.tsx("div", { bind: this, class: CSS.base, classes: classes },
                widget_1.tsx("div", { class: CSS.background },
                    widget_1.tsx("div", { class: CSS.border },
                        widget_1.tsx("div", { class: CSS.label }, "drop here")))));
            var _a;
        };
        DropTarget.prototype._dragEnterHandler = function (event) {
            this.visible = true;
            if (this.validate) {
                this.isValid = this.validate(event.dataTransfer);
            }
            else {
                this.isValid = true;
            }
        ...
        __decorate([
            widget_1.renderable()
        ], DropTarget.prototype, "visible", void 0);
        __decorate([
            widget_1.renderable()
        ], DropTarget.prototype, "isValid", void 0);
        __decorate([
